    ...
    <nav class="gradient-bg text-white shadow-lg relative">
        <div class="container mx-auto px-4 sm:px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <button onclick="toggleEditMode()" class="action-button bg-white text-indigo-600 px-3 py-2 sm:px-4 sm:py-2 rounded-lg shadow hover:bg-gray-100 transition duration-200 flex items-center text-sm sm:text-base">
            ...
            <div class="gradient-bg px-6 py-6">
                <div class="flex profile-header items-center">
                    ...
                    <div class="profile-info ml-0 sm:ml-6 mt-4 sm:mt-0">
                        <h2 class="text-xl sm:text-2xl font-bold text-white"><?php echo htmlspecialchars($username); ?></h2>
            ...
            <div class="lg:col-span-1 order-2 lg:order-1">
                <div class="card bg-white rounded-2xl shadow-md p-5">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="homepage.php" class="stat-card flex items-center p-3 bg-red-50 rounded-xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="gender" class="w-full p-3 pl-10 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 appearance-none" 
                                            disabled>
                                        ...
                                        <option value="Others" <?php echo strtolower($gender) === 'others' ? 'selected' : ''; ?>>Other</option>
                                    </select>
