...
<body class="bg-gray-50 min-h-screen">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-medium"><?php echo htmlspecialchars($booking['from_location']); ?>
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-medium"><?php echo htmlspecialchars($booking['to_location']); ?>
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-medium"><?php echo htmlspecialchars($booking['boarding_point']); ?>
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-medium"><?php echo htmlspecialchars($booking['dropping_point']); ?>
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-medium"><?php echo htmlspecialchars($booking['selected_seats']); ?>
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-800 font-medium">₹<?php echo number_format($booking['total_amount'], 2); ?>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-6 border-b border-gray-200">
                ...
                <form method="POST" action="sellDB.php">
                    ...
                    <input type="hidden" name="journeydate"
                        value="<?php echo htmlspecialchars($booking['journeydate']); ?>">
                    <input type="hidden" name="from_location"
                        value="<?php echo htmlspecialchars($booking['from_location']); ?>">
                    <input type="hidden" name="to_location"
                        value="<?php echo htmlspecialchars($booking['to_location']); ?>">
                    <input type="hidden" name="boarding_time"
                        value="<?php echo htmlspecialchars($booking['boarding_time']); ?>">
                    <input type="hidden" name="dropping_time"
                        value="<?php echo htmlspecialchars($booking['dropping_time']); ?>">
                    <input type="hidden" name="boarding_point"
                        value="<?php echo htmlspecialchars($booking['boarding_point']); ?>">
                    <input type="hidden" name="dropping_point"
                        value="<?php echo htmlspecialchars($booking['dropping_point']); ?>">
                    <input type="hidden" name="selected_seats"
                        value="<?php echo htmlspecialchars($booking['selected_seats']); ?>">
                    <input type="hidden" name="total_amount"
                        value="<?php echo htmlspecialchars($booking['total_amount']); ?>">
                    <input type="hidden" name="booking_status"
                        value="<?php echo htmlspecialchars($booking['booking_status']); ?>">
    ...
    <script>
        // Add a simple validation for the form submission
