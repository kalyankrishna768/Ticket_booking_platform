...
<body>
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="manage_agency.php" class="sidebar-link active"><i class="fas fa-building"></i> Bus Agencies</a></li>
    ...
    <div class="topbar">
            <div class="user-profile ms-auto"> <!-- Moved to right with ms-auto -->
            ...
            <div class="filter-card">
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-3 col-sm-6">
                        <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#addAgencyModal">
                    ...
                    <div class="col-md-9 col-sm-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="searchInput" placeholder="Search agencies by name or email...">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="editAgencyModal" tabindex="-1" aria-labelledby="editAgencyModalLabel" aria-hidden="true" <?php echo $edit_data ? 'data-bs-backdrop="static"' : ''; ?>>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
