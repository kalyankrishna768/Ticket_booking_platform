    ...
    <script>
        ...
        function editRoute(routeId) {
            fetch(`routes.php?action=get&id=${routeId}`, {
                ...
                .then(data => {
                    if (data) {
                        document.getElementById('modalTitle').innerHTML = '<i class="fas fa-edit text-blue-500 mr-2"></i>Edit Route';
        ...
        function showRouteDetails(routeId) {
            fetch(`routes.php?action=get&id=${routeId}`)
                ...
                .then(data => {
                    ...
                    fromPointsHTML += '<div class="col-span-2 font-medium text-blue-600 flex items-center mb-1"><i class="fas fa-map-pin text-orange-500 mr-1"></i>Boarding Points:</div>';
                    ...
                    try {
                        ...
                        if (Array.isArray(fromPoints) && fromPoints.length > 0) {
                            ...
                            fromPointsHTML += '<div class="col-span-2 text-gray-500 pl-4">No boarding points specified</div>';
                        }
                    } catch (e) {
                        fromPointsHTML += '<div class="col-span-2 text-gray-500 pl-4">No boarding points specified</div>';
                    }
                    ...
                    toPointsHTML += '<div class="col-span-2 font-medium text-blue-600 flex items-center mb-1"><i class="fas fa-map-pin text-green-500 mr-1"></i>Dropping Points:</div>';
