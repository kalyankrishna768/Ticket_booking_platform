...
<body>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-md-9 col-sm-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="searchInput" placeholder="Search users by username or email...">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <?php if ($result && $result->num_rows > 0): ?>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="manage_users.php?edit_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-success me-2">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="manage_users.php?delete_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure you want to delete this user?');">
    ...
    <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true" <?php echo $edit_data ? 'data-bs-backdrop="static"' : ''; ?>>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form method="POST" action="manage_users.php">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="edit_username" name="username" value="<?php echo $edit_data ? htmlspecialchars($edit_data['username']) : ''; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="edit_email" class="form-label">Email Address</label>
                            <input type="email" class="form-control" id="edit_email" name="email" value="<?php echo $edit_data ? htmlspecialchars($edit_data['email']) : ''; ?>" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="edit_phonenumber" name="phonenumber" value="<?php echo $edit_data ? htmlspecialchars($edit_data['phonenumber']) : ''; ?>" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="edit_gender" name="gender" required>
                                ...
                                <option value="Others" <?php echo ($edit_data && $edit_data['gender'] == 'Others') ? 'selected' : ''; ?>>Others</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="edit_address" class="form-label">Address</label>
                            <textarea class="form-control" id="edit_address" name="address" rows="3" required><?php echo $edit_data ? htmlspecialchars($edit_data['address']) : ''; ?></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
