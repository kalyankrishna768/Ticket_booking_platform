        ...
        <div class="container-fluid py-4">
            ...
            <div class="filter-card">
                ...
                <form method="POST" action="" class="row g-3 align-items-center">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <button type="submit" name="add_money" class="btn btn-primary w-100"><i class="fas fa-plus me-2"></i>Add Money</button>
                    </div>
                </form>
            </div>
            ...
            <div class="filter-card">
                ...
                <form method="POST" action="" class="row g-3 align-items-center">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <button type="submit" name="filter_date" class="btn btn-primary w-100"><i class="fas fa-filter me-2"></i>Filter</button>
                    </div>
                    <div class="col-md-3 col-sm-6">
