...
<body>
    <div class="container">
        ...
        <div class="booking-summary">
            ...
            <div class="form-row">
                <div>
                    <p><strong><i class="fas fa-map-marker-alt"></i> From:</strong> <?php echo htmlspecialchars($_POST['from']); ?></p>
                    <p><strong><i class="fas fa-map-pin"></i> To:</strong> <?php echo htmlspecialchars($_POST['to']); ?></p>
                </div>
                <div>
                    <p><strong><i class="far fa-calendar-alt"></i> Date:</strong> <?php echo htmlspecialchars($_POST['journeydate']); ?></p>
                    <p><strong><i class="fas fa-ticket-alt text-indigo-600"></i> Selected Seats:</strong> <?php echo htmlspecialchars($selected_seats); ?></p>
                </div>
                <div>
                    <p><strong><i class="fas fa-tag"></i> Total Amount:</strong> <?php echo htmlspecialchars($total_amount); ?></p>
                </div>
            </div>
        </div>
                ...
                <div class="passenger-form">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="passenger_name[]" required pattern="[A-Za-z ]{1,255}" title="Please enter a valid name (letters and spaces only)">
                        </div>
                        <div class="form-group">
                    ...
                    <input type="tel" name="passenger_phone[]" required pattern="[0-9]{10,15}" title="Please enter a valid phone number (10-15 digits)">
                </div>
                <div class="form-group">
