        ...
        <div class="container-fluid py-4">
            ...
            <div class="row g-4 mt-2">
                <div class="col-md-4">
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <a href="admin_wallet.php" class="quick-card">
                        ...
                        <div class="col-6">
                            <a href="admin_bookings.php" class="quick-card">
                                ...
                                <span class="action-text">Bookings</span>
                            </a>
                        </div>
                        <div class="col-6">
    ...
    <script>
        ...
        document.querySelectorAll('.view-ticket').forEach(button => {
            button.addEventListener('click', function () {
                ...
                document.getElementById('modal-ticket-price').textContent = '₹' + getValue(data.ticketPrice);
                document.getElementById('modal-convenience-fee').textContent = '₹' + getValue(data.convenienceFee);
