        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="message-detail-row"><span class="message-label">Message ID:</span><span id="modal-message-id"></span></div>
                    <div class="message-detail-row"><span class="message-label">Username:</span><span id="modal-username"></span></div>
                    <div class="message-detail-row"><span class="message-label">Email:</span><span id="modal-email"></span></div>
                    <div class="message-detail-row"><span class="message-label">Subject:</span><span id="modal-subject"></span></div>
                    <div class="message-detail-row"><span class="message-label">Message:</span><span id="modal-message"></span></div>
                </div>
