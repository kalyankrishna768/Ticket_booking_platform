        ...
        <header class="mb-8 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <a href="myuploads.php"
                    class="btn bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition flex items-center shadow-md">
                    <i class="ri-arrow-left-line mr-2"></i>Back to My Uploads
                </a>
            </div>
        </header>
