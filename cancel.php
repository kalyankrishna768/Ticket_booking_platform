...
// This handles any legacy data that might not have booking_id properly set
...
WHERE bus_id = ? AND from_location = ? AND to_location = ? AND journey_date = ? AND seat_number = ?";
        ...
        if ($refund_amount > 0) {
            ...
            $stmt_transaction->bind_param("isds", $wallet_id, $transaction_type, $refund_amount, $transaction_date);
            $stmt_transaction->execute();

            // FIX 3: Update agency_wallet_transactions with correct transaction type
            $transaction_type = "debit"; // or "credit" depending on the refund logic
        ...
        <div class="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
            <div class="flex items-center justify-between">
                <a href="mybookings.php"
                    class="back-button flex items-center text-white hover:text-gray-200 transition-all duration-300">
