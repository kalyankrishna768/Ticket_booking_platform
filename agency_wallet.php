...
class WalletManager {
    ...
    public function getTransactionHistory() {
        $stmt = $this->conn->prepare(
            "SELECT * FROM agency_wallet_transactions 
            WHERE email = ? 
...
<body class="bg-gray-50">
    ...
    <!-- Add Money Modal -->
    <div id="addMoneyModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-lg w-full max-w-md p-6 relative max-h-[90vh] overflow-y-auto">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-4"><i class="fas fa-wallet text-blue-600 mr-2"></i>Add Money to Wallet</h3>
            <div class="space-y-4">
                <div class="relative">
    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <div class="md:hidden bg-blue-700 text-white p-4 flex justify-between items-center sticky top-0 z-20">
            <h1 class="text-xl font-bold"><i class="fas fa-user-circle mr-2"></i><?php echo ucfirst($_SESSION['username']); ?></h1>
        ...
        <div class="flex-1 overflow-x-hidden overflow-y-auto main-content">
            ...
            <header class="bg-white shadow-sm hidden md:block">
                <div class="flex items-center justify-between px-6 py-4">
                    <h1 class="text-xl font-semibold"><i class="fas fa-wallet text-blue-600 mr-2"></i>Wallet Management</h1>
            ...
            <main class="p-4 md:p-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-800"><i class="fas fa-coins text-yellow-500 mr-2"></i>Available Balance</h2>
                            <p class="text-3xl font-bold text-blue-600 mt-2"><i class="fas fa-rupee-sign text-2xl mr-1"></i><?php echo number_format($balance, 2); ?></p>
                        </div>
                        <button onclick="openModal()" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    <div class="p-4 border-b border-gray-200">
                        <h2 class="text-lg font-semibold"><i class="fas fa-history text-blue-600 mr-2"></i>Transaction History</h2>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 md:px-6 py-4 whitespace-nowrap">
                                        <i class="far fa-calendar-alt text-gray-500 mr-1"></i> <?php echo date('d M Y', strtotime($transaction['transaction_date'])); ?>
                                    </td>
                                    <td class="px-4 md:px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-4 md:px-6 py-4 whitespace-nowrap font-medium 
                ...
                <div id="transactionDetailsModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
                    <div class="fixed inset-0 bg-black bg-opacity-50" onclick="document.getElementById('transactionDetailsModal').classList.add('hidden')"></div>
                    <div class="relative flex items-center justify-center min-h-screen p-4">
                        <div class="relative mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg font-medium text-gray-900"><i class="fas fa-info-circle text-blue-600 mr-2"></i>Transaction Details</h3>
                                <button type="button" onclick="document.getElementById('transactionDetailsModal').classList.add('hidden')" 
            ...
            for (let row of transactionRows) {
                ...
                if (cells[0].textContent.replace('#', '') == id) {
                    transaction = {
                        ...
                        type: cells[3].querySelector('span')?.textContent.trim() || cells[4].textContent.includes('text-green') ? 'Credit' : 'Debit',
