...
<head>
    ...
    <style>
        ...
        .balance-gradient {
            background: linear-gradient(135deg, rgba(16, 185, 129, 0.8) 0%, rgba(6, 95, 70, 0.9) 100%);
        }
    ...
    <div class="sticky top-0 bg-white shadow-md z-10">
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-3">
                <a href="profile.php" class="flex items-center text-indigo-700 hover:text-indigo-500 transition">
                ...
                <div class="balance-gradient p-6 sm:p-8 text-white relative overflow-hidden">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center relative z-10">
                        ...
                        <button onclick="openAddFundsModal()" 
                            class="add-funds-button bg-white text-green-700 px-6 py-3 rounded-lg hover:bg-green-50 transition transform hover:scale-105 flex items-center">
