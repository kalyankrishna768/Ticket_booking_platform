        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="bus-detail-row"><span class="bus-label">Bus ID:</span><span id="modal-bus-id"></span></div>
                    <div class="bus-detail-row"><span class="bus-label">Bus Number:</span><span id="modal-bus-number"></span></div>
                    <div class="bus-detail-row"><span class="bus-label">Capacity:</span><span id="modal-capacity"></span></div>
                    <div class="bus-detail-row"><span class="bus-label">Type:</span><span id="modal-type"></span></div>
                    <div class="bus-detail-row"><span class="bus-label">Status:</span><span class="status-badge" id="modal-status"></span></div>
                    <div class="bus-detail-row"><span class="bus-label">Created At:</span><span id="modal-created-at"></span></div>
                    <div class="bus-detail-row"><span class="bus-label">Updated At:</span><span id="modal-updated-at"></span></div>
                    <div class="bus-detail-row"><span class="bus-label">Agency Username:</span><span id="modal-user-name"></span></div>
                    <div class="bus-detail-row"><span class="bus-label">Agency Email:</span><span id="modal-email"></span></div>
                </div>
