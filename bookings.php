...
<body class="bg-gray-50">
            ...
            <header class="bg-white shadow-sm hidden md:block">
                <div class="flex items-center justify-between px-4 md:px-6 py-4">
                    <div class="flex items-center">
                        <h1 class="text-xl font-semibold"><i class="fas fa-ticket-alt text-blue-600 mr-2"></i>Bookings Management</h1>
                    </div>
                    <div class="flex items-center">
                ...
                <div class="filter-section mb-4">
                    <form method="GET" action="" class="flex items-center flex-grow">
                        <div class="relative flex items-center flex-grow">
                            ...
                            <button type="submit" class="absolute right-0 top-0 bottom-0 px-3 bg-blue-600 text-white rounded-r-lg search-button">
                    ...
                    <form method="GET" action="" id="dateFilterForm" class="flex items-center">
                        <select name="date_filter" onchange="handleDateFilterChange(this)" class="py-2 px-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="">All Dates</option>
                            <option value="today" <?php echo $dateFilter === 'today' ? 'selected' : ''; ?>>Today's Bookings</option>
            ...
            <main class="p-4 md:p-6">
                    ...
                    <div class="relative flex items-center justify-center min-h-screen p-4">
                        <div class="relative mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white modal-content">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <button type="button" onclick="closeSelectDateModal()" class="text-gray-400 hover:text-gray-500">
                            ...
                            <form id="selectDateForm" method="GET" action="">
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="date" name="start_date" id="startDateInput" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">End Date</label>
                                        <input type="date" name="end_date" id="endDateInput" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3">
                                    </div>
                                </div>
                                <div class="mt-4 flex justify-end space-x-3">
                                    <button type="button" onclick="closeSelectDateModal()" class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400 transition duration-150">
                                        Cancel
                                    </button>
                                    <button type="button" onclick="applyDateRange()" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition duration-150">
                                        Apply
                                    </button>
                                </div>
                            </form>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="hidden md:table-cell px-4 md:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                ...
                                <?php if (count($allBookings) > 0): ?>
                                    <?php foreach ($allBookings as $booking): ?>
                                        <tr class="hover:bg-gray-50" data-booking-id="<?php echo $booking['id']; ?>">
                                            ...
                                            <td class="hidden md:table-cell px-4 md:px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <td class="px-4 md:px-6 py-4 whitespace-nowrap text-sm">
                                                <button onclick="viewBooking(<?php echo $booking['id']; ?>)" class="text-blue-600 hover:text-blue-900 mr-2 transition duration-150" title="View Booking">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="9" class="px-4 py-6 text-center text-gray-500">
                                            ...
                                            <p>No bookings found<?php echo !empty($searchQuery) ? ' matching "' . htmlspecialchars($searchQuery) . '"' : ''; ?></p>
                                            <?php if (!empty($searchQuery)): ?>
                                                <a href="bookings.php" class="text-blue-600 hover:text-blue-800 inline-block mt-2">
                ...
                <div id="bookingDetailsModal" class="hidden fixed inset-0 z-50 overflow-y-auto">
                    ...
                    <div class="relative flex items-center justify-center min-h-screen p-4">
                        <div class="relative mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white modal-content">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg font-medium text-gray-900"><i class="fas fa-info-circle text-blue-600 mr-2"></i>Booking Details</h3>
                            ...
                            <div class="mt-4 flex justify-end">
                                <button type="button" onclick="closeModal()" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition duration-150">
    ...
    <script>
        ...
        function applyDateRange() {
            ...
            window.location.href = `bookings.php?start_date=${encodeURIComponent(startDate)}&end_date=${encodeURIComponent(endDate)}`;
        }
